...
import { Loader2, Shield, Users, BarChart3, Bell, CreditCard, Settings, History } from "lucide-react"
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    console.log("[v0] Dashboard useEffect - user:", user, "loading:", loading)
    ...
    if (!loading) {
      ...
      // Regular approved user stays on dashboard
    }
  }, [user, loading, router])
